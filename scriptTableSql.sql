...
-- attention les lignes avis ci dessous vont bien fonctionner en début de formation.
-- Mais des qu'on introduit un lien dans le code avec UserId (Section Identity), le mieux serait de supprimer ces lignes de la table pour en recréer à partir du site car les UserId ci dessous sont créés automatiquement par Identity et n'existent donc que sur mon poste. 
